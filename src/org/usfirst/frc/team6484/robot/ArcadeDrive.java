 ...
 */
public class ArcadeDrive implements MotorSafety {
 ...
 * @return 
   */
  public ArcadeDrive(final int leftMotorChannel, final int rightMotorChannel) {
 ...
 * @return 
   */
  public ArcadeDrive(final int frontLeftMotor, final int rearLeftMotor, final int frontRightMotor,
 ...
 * @return 
   */
  public ArcadeDrive(SpeedController frontLeftMotor, SpeedController rearLeftMotor,
  ...
  public void arcadeDrive(GenericHID moveStick, final int moveAxis, GenericHID rotateStick,
          final int rotateAxis, GenericHID throttleStick, final int throttleAxis, boolean squaredInputs) {
double moveValue = moveStick.getRawAxis(moveAxis);
double rotateValue = rotateStick.getRawAxis(rotateAxis);
double throttleValue = (-1 * (throttleStick.getRawAxis(throttleAxis) - 1) / 4) + .5; 
SmartDashboard.putString("DB/String 4", Double.toString(throttleValue));

arcadeDrive(moveValue, rotateValue, throttleValue, squaredInputs);
}
  ...
  public void arcadeDrive(double moveValue, double rotateValue, boolean squaredInputs) {
    ...
    rotateValue = -1 * limit(rotateValue);
...
//        System.out.println(rightMotorSpeed);
        ...
        SmartDashboard.putString("DB/String 0", Double.toString(leftMotorSpeed));
        SmartDashboard.putString("DB/String 5", Double.toString(rightMotorSpeed));
      } else {
        leftMotorSpeed = moveValue - rotateValue;
        rightMotorSpeed = -Math.max(-moveValue, -rotateValue);
      }
   ...
   * @param squaredInputs If set, decreases the sensitivity at low speeds
   */
  public void arcadeDrive(double moveValue, double rotateValue, double throttleValue, boolean squaredInputs) {
    // local variables to hold the computed PWM values for the motors
    if (!kArcadeStandard_Reported) {
      HAL.report(tResourceType.kResourceType_RobotDrive, getNumMotors(),
          tInstances.kRobotDrive_ArcadeStandard);
    ...
    moveValue = limit(moveValue) * throttleValue;
    rotateValue = -1 * limit(rotateValue) * throttleValue;
